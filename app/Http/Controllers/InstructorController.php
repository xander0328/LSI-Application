...
class InstructorController extends Controller
{
    ...
    public function post(Request $request)
    {
        ...
        // dd($Messagecontent);
        $batch = Batch::with('enrollee.user.device_tokens', 'course')->find($request->batch_id);
        $deviceTokens = $batch->enrollee->flatMap(function ($enrollee) {
            return $enrollee->user->device_tokens->pluck('device_token');
        })->toArray();
