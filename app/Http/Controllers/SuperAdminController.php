...
class SuperAdminController extends Controller
{
    ...
    {
        // dump(Course::all());
        $course = Course::with(['course_category', 'course_id_template'])->withCount([
    ...
    public function dashboard_course($id)
    {
        $course = Course::where('id', $id)
            ->with(['batches.enrollee', 'course_category'])
        ...
        return view('dashboard_course', compact('course'));
    }
