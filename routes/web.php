...
Route::middleware(['auth', 'verified', 'role:superadmin'])->group(function () {
    Route::prefix('dashboard')->group(function () {
        ...
        Route::get('/{id}', [SuperAdminController::class, 'dashboard_course'])->name('dashboard_course');
    });
...
Route::get('/get_all_notifications', [StudentController::class, 'get_all_notifications'])->name('get_all_notifications');
