<x-app-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center justify-between text-black dark:text-white">
            <div
                class="flex-row items-center text-2xl font-semibold dark: text-sky-950 dark:text-white md:flex md:space-x-1">
                <div>{{ __('Stream') }}</div>
    ...
    <div x-data="stream" id="course_list" class="pt-40 pb-20 mx-4 text-black dark:text-white md:mx-8 md:pt-44">
        <div class="flex flex-col-reverse py-6">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="relative cursor-pointer">
                                    <x-dropdown width="40" align="right">
                                        <x-slot name="trigger">
                                            <button
                                                class="inline-flex items-center text-sm font-medium leading-4 text-black transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:text-gray-700 focus:outline-none dark:bg-gray-800 dark:text-gray-400 dark:hover:text-gray-300">
                                                <svg class="text-black h-7 w-7 hover:text-sky-500 dark:text-white"
                                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                    <path fill="currentColor"
                                ...
                                <div class="mt-1.5 rounded bg-sky-600 text-white hover:bg-sky-700 md:w-1/5">
                                    ...
                                    .replace(':post_id', post.id)"
                                        ...
                                        <span x-text="post.comments_count"
                                            class="flex items-center justify-center w-4 h-4 text-xs text-black bg-white rounded-full ms-1">
                                        </span>
                                    </a>
                                </div>
                            </div>
            ...
            <template x-if="batch.completed_at == null">
                <div data-dial-init class="fixed group bottom-6 end-6">
                    <div id="speed-dial-menu-text-inside-button-square"
                        ...
                        <button type="button" @click="edit = false; createPost()"
                            ...
                            <svg class="w-4 h-4 mx-auto mb-1" fill="currentColor"xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24">
                            ...
                            <span class="block mb-px text-xs font-medium">Post</span>
                        </button>
                    ...
                    <button type="button" data-dial-toggle="speed-dial-menu-text-inside-button-square"
                        ...
                        class="flex items-center justify-center text-white bg-blue-700 rounded-lg h-14 w-14 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            ...
            <div class="relative w-full max-w-xl max-h-full p-4">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex items-center justify-between p-4 border-b rounded-t dark:border-gray-600 md:p-5">
                        ...
                        <button type="button"
                            class="inline-flex items-center justify-center w-8 h-8 text-sm text-gray-400 bg-transparent rounded-lg ms-auto hover:bg-gray-200 hover:text-gray-900 dark:text-white dark:hover:bg-gray-600"
                    ...
                    <form id="post_form" action="{{ route('post') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div class="text-xs text-black rounded-full dark:text-white">
                                <a class="flex items-center cursor-pointer" @click="toggleShowAddFile()">Attach
                                    File/s
                                    <svg x-show="showAddFile" class="w-4 h-4 ml-2 text-black dark:text-white"
                                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="none" viewBox="0 0 24 24">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m5 15 7-7 7 7" />
                                    </svg>
                                    <svg x-show="!showAddFile" class="w-4 h-4 ml-2 text-gray-800 dark:text-white"
