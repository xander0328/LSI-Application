                    ...
                    <div class="flex">
                        @foreach ($post->files as $files)
                            @if (Str::startsWith($files->file_type, 'image/'))
                                <div class="mb-2"> <img class="h-48 w-auto flex-1"
                                        src="{{ asset('storage/' . $files->path) }}"
                ...
                <form id="post_form" action="{{ route('post') }}" method="post" enctype="multipart/form-data"
                    ...
                    <div class="mb-4 grid grid-cols-2 gap-4">
                        <div class="col-span-2">
                            <label for="message"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Message</label>
                        ...
                        <div class="col-span-2">
                            <label for="name"
                                class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">File</label>
