    <div>
        @if (auth()->user()->role == 'student')
            <div class="mt-2 mx-2 md:flex grid grid-rows-3 md:gap-2 gap-1 items-center justify-start text-white">
                <a href="{{ route('enrolled_course') }}">
                    <button
                        class="{{ $selected == 'stream' ? 'bg-sky-700 text-white' : 'text-sky-950' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm hover:bg-gray-300 dark:text-white dark:hover:bg-gray-800 ">
                ...
                <a href="{{ route('enrolled_course_assignment') }}">
                    <button
                        class="{{ $selected == 'assignment' ? 'bg-sky-700 text-white' : 'text-sky-950' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm hover:bg-gray-300 dark:text-white dark:hover:bg-gray-800 ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-1 h-5 w-5">
                            <path fill="currentColor"
                ...
                <a href="{{ route('enrolled_course_attendance') }}">
                    <button
                        class="{{ $selected == 'attendance' ? 'bg-sky-700 text-white' : 'text-sky-950' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm hover:bg-gray-300 dark:text-white dark:hover:bg-gray-800 ">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-1 h-5 w-5">
