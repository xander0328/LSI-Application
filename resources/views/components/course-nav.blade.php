        ...
        @if (auth()->user()->role == 'student')
            <div class="mt-2 mx-2 md:flex grid grid-rows-3 md:gap-2 gap-1 items-center justify-start text-white">
                <a href="{{ route('enrolled_course') }}">
                    <button
                        class="{{ $selected == 'stream' ? 'bg-sky-700' : '' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm text-white hover:bg-gray-800 md:hover:bg-gray-700">
                ...
                <a href="{{ route('enrolled_course_assignment') }}">
                    <button
                        class="{{ $selected == 'assignment' ? 'bg-sky-700' : '' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm text-white hover:bg-gray-800 md:hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-1 h-5 w-5">
                ...
                <a href="{{ route('enrolled_course_attendance') }}">
                    <button
                        class="{{ $selected == 'attendance' ? 'bg-sky-700' : '' }} w-full flex items-center md:justify-center justify-start rounded px-3 py-1.5 text-sm text-white hover:bg-gray-800 md:hover:bg-gray-700">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="mr-1 h-5 w-5">
