<template x-if="file.file_type === 'application/pdf'">
    <div class="mb-2">
        <a :href="path" target="_blank" class="text-md flex rounded-md bg-gray-600 p-2 hover:bg-gray-500">
            ...
            <span x-text="file.filename.replace('uploads/', '').split('_').slice(2).join('_')"></span>
        </a>
    </div>
</template>
...
<template x-if="file.file_type.endsWith('document')">
    <div class="mb-2">
        <a :href="path" target="_blank" download
            class="text-md flex rounded-md bg-gray-600 p-2 hover:bg-gray-500">
...
<template x-if="file.filename.endsWith('.txt')">
    <div class="mb-2">
        <a :href="path" target="_blank" download
            class="text-md flex rounded-md bg-gray-600 p-2 hover:bg-gray-500">
