                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="col-span-2">
                                ...
                                <div class="relative mt-4 rounded-md bg-gray-800/75 text-white">
                                    ...
                                    {{-- Skeleton --}}
                                    <div role="status" x-cloak x-show="dataLoading"
                                        class="w-full animate-pulse space-y-4 divide-y divide-gray-200 rounded px-2 pb-4 pt-10 shadow dark:divide-gray-700 dark:border-gray-700">
